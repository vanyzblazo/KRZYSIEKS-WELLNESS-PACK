...
function pathConflictResolutionWindow()
    ...
    if show_global_replacement_conflicts then
        ...
        reaper.ImGui_SetNextWindowSizeConstraints(ctx, 968, 400, 968, 1000)
        ...
        if should_display then
            ...
            if reaper.ImGui_BeginTable(ctx, "ConflictTable", 4, table_flags) then
                ...
                reaper.ImGui_TableSetupColumn(ctx, "Used In Hierarchies", reaper.ImGui_TableColumnFlags_WidthFixed(), 380)
